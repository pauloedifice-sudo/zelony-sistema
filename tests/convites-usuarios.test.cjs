...
test('pagina forca assets atuais e bloqueia convite enviado por aba desatualizada', () => {
  assert.equal(versionInfo.version, '20260919.2');
  assert.match(indexSource, /js\/supabase-boot\.js\?v=20260919\.2/);
  assert.match(indexSource, /js\/usuarios\.js\?v=20260919\.2/);
  assert.match(indexSource, /css\/styles\.css\?v=20260919\.2/);
