...
const ETAPAS=['Aguardando demanda','Entrevista','Ass. formulÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡rios','Envio CEHOP','Entrevista Caixa','Aguard. Ass. CEF','Assinado CEF','Nota emitida','ComissÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o recebida'];
const PRAZOS_ETAPA=[null,5,5,6,3,3,4,15,null];

const PROC_DATA={'Comercial':[{nome:'CaptaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o de imÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³veis',etapas:8,status:'Ativo',badge:'bg-g',steps:['ProspecÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o do imÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³vel','AvaliaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o de mercado','Visita tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©cnica','DocumentaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o do proprietÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡rio','Assinatura de exclusividade','Cadastro no sistema','PublicaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o nas plataformas','Acompanhamento de leads']},{nome:'Processo de venda',etapas:12,status:'Ativo',badge:'bg-g',steps:['Atendimento do lead','QualificaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o do cliente','ApresentaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o do imÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³vel','Proposta inicial','NegociaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o','AprovaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o do crÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dito','Assinatura de promessa','AnÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lise jurÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­dica','CEHOP','Entrevista Caixa','Assinatura CEF','Entrega das chaves']},{nome:'LocaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o de imÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³veis',etapas:10,status:'Ativo',badge:'bg-g',steps:['CaptaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o do imÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³vel','DivulgaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o','Atendimento','Visita','Proposta','AnÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lise cadastral','Assinatura do contrato','Vistoria de entrada','Pagamento de taxas','Entrega das chaves']}],'JurÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­dico':[{nome:'Contratos e escritura',etapas:6,status:'RevisÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o',badge:'bg-a',steps:['Minuta do contrato','RevisÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o jurÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­dica','Assinatura das partes','Reconhecimento de firma','Registro em cartÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³rio','Entrega do documento']}],'Financeiro':[{nome:'Repasse de comissÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âµes',etapas:7,status:'Ativo',badge:'bg-g',steps:['Nota fiscal emitida','ValidaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o dos valores','AprovaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o do gerente','AprovaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o do diretor','Processamento bancÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡rio','DepÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³sito realizado','Comprovante enviado']}],'RH / Pessoas':[{nome:'Onboarding de corretor',etapas:5,status:'Rascunho',badge:'bg-gr',steps:['DocumentaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o admissional','ApresentaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o da empresa','Treinamento inicial','Acompanhamento na primeira venda','AvaliaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o de 30 dias']},{nome:'AvaliaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o de desempenho',etapas:4,status:'Pendente',badge:'bg-r',steps:['Coleta de mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tricas','ReuniÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o com gestor','Plano de desenvolvimento','Registro no sistema']}]};
...
function comZ(v){ return com(v,Math.max(v.pct-v.pct_cor-v.pct_cap-v.pct_ger-v.pct_dir-(v.pct_dir2||0),0)); }
