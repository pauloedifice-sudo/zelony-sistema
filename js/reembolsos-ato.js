  ...
  return `<div class="folha-modal-backdrop" id="ato-modal-backdrop" onclick="atoFecharModalBackdrop(event)">
    <form class="folha-modal" onsubmit="atoSalvar(event)">
      ...
      <div class="folha-form-grid">
        ...
        <label class="folha-field"><span>Valor a reembolsar</span><div class="folha-money-input"><b>R$</b><input id="ato-valor" type="text" inputmode="decimal" value="${atoEscape(item?atoValorCampo(item.valor):'')}" placeholder="0,00" autocomplete="off" required oninput="zMascararValorMonetario(this)" onblur="zFinalizarValorMonetario(this,false)"></div></label>
